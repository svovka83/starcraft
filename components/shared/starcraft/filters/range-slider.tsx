  ...
  (
    ...
    return (
      <SliderPrimitive.Root
        ...
        className={cn(
          "relative flex touch-none select-none mb-6 items-center mx-12 ",
          className
        )}
        {...props}
      >
        <SliderPrimitive.Track className="relative h-1 w-full grow overflow-hidden rounded-full bg-violet-700/20">
