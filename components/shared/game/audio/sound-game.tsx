...
export const SoundGame: React.FC = () => {
  ...
  return (
    <>
      <Button
        className="absolute bg-indigo-500 hover:bg-indigo-700 bottom-40 right-4 text-white z-40"
        onClick={playSoundOne}
      >
        {isPlayingOne ? <AudioLines /> : <OctagonPause />}
      </Button>
      <Button
        className="absolute bg-violet-500 hover:bg-violet-700 bottom-28 right-4 text-white z-40"
