  ...
  return (
    <div
      className={cn(
        ...
        "fixed top-[10vh] bg-black/0 bottom-0 flex justify-center items-center text-6xl font-extrabold cursor-pointer z-30 group transition-all hover:bg-black/20 duration-300",
        className
      )}
    >
      {turn ? (
