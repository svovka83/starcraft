...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md active:translate-y-[1px] text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:bg-gray-500',
  {
    variants: {
      variant: {
        success: 'bg-green-700 text-primary-foreground hover:bg-green-700/85 text-md',
        default: 'bg-primary text-primary-foreground hover:bg-primary/85 text-md',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/85 text-md',
        outline: 'border border-primary text-primary bg-transparent hover:bg-primary/15 text-md',
